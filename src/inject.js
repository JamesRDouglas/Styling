...
function updateStyles() {
  let localStorage = browser.storage.local.get(function(item) {
    ...
    if (!item.styling_1) { browser.storage.local.set({ styling_1: { block_1: { code: "", url_1: "", url_1_type: "url" }, options: { tab_size: "2", font_size: "11", autocomplete: "true", tab_indent: "false", guide_indent: "false", show_invisible: "false", theme: "crimson_editor", keybinding: "default" } } }).then(onChange, onError); }
