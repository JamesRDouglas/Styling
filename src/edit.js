...
$(function() {
  ...
  $(document).on('click', '.beautify_block', function() { alert('beautify'); ace.require("ace/ext/beautify").beautify(ace.edit($(this).parent().children('div.code:first-of-type')).session); });
