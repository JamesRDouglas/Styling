...
browser.runtime.onMessage.addListener(function(message) { if (message.message === "styles enabled" || message.message === "styles enabled") {  } });
browser.runtime.onMessage.addListener(function(message) { if (message.message === "style updated") { $('#active-styles').empty(); browser.storage.local.get(function(item) { loadStyles(item); }); } });
